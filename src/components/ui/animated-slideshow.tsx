    ...
    >
      {characters.map((char, index) => (
        ...
        >
          ...
          >
            <motion.span
              className={cn("inline-block transition-opacity duration-300", isActive ? "opacity-100" : "opacity-20")}
              initial={{ y: "0%" }}
            ...
            <motion.span
              className="absolute left-0 top-0 inline-block opacity-100 text-[#4F46E5]"
              initial={{ y: "110%" }}
...
export const SLIDES = [
  {
    id: "slide-1",
    title: "Plombier Saint-Germain",
    imageUrl: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?q=80&w=1200",
  },
  {
    id: "slide-2",
    title: "Électricien Lyon Centre",
    imageUrl: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?q=80&w=1200",
  },
  {
    id: "slide-3",
    title: "Menuisier Bordeaux",
    imageUrl: "https://images.unsplash.com/photo-1533090161767-e6ffed986c88?q=80&w=1200",
  },
  {
    id: "slide-4",
    title: "Peintre Nantes",
    imageUrl: "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?q=80&w=1200",
  },
  {
    id: "slide-5",
    title: "Couvreur Lille",
    imageUrl: "https://images.unsplash.com/photo-1632759145351-1d592919f522?q=80&w=1200",
  },
]
